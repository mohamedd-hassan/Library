...
% sections:
\EN{\input{other/MUL_IMUL_EN}}
\RU{\input{other/MUL_IMUL_RU}}
\DE{\input{other/MUL_IMUL_DE}}
\FR{\input{other/MUL_IMUL_FR}}
...
\FR{\input{other/hexrays_FR}}

\EN{\input{other/cyclomatic/main_EN}}
\FR{\input{other/cyclomatic/main_FR}}
